...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "谷底和第二个峰值y轴距离(um)："))
        self.label_10.setText(_translate("MainWindow", "压力角误差(um/mm)："))
        self.label_11.setText(_translate("MainWindow", "第二个峰值增益误差(%)："))
        self.label_12.setText(_translate("MainWindow", "第二个峰值滞后误差(%)："))
